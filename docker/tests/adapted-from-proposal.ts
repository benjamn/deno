// Directly inspired by this test file (with slightly different imports, etc):
// https://github.com/legendecas/proposal-async-context/blob/master/tests/async-context.test.ts
